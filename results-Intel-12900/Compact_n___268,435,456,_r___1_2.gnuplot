...
plot './results/Compact_n___268,435,456,_r___1_2.dat' using 1:2 title "Scan-then-propagate" ls 3 lw 1 pointsize 0.6 pointtype 13 with linespoints, \
  ...
  './results/Compact_n___268,435,456,_r___1_2.dat' using 1:5 title "Assisted scan-t.-prop." ls 2 lw 1 pointsize 0.7 pointtype 12 with linespoints, \
  ...
  './results/Compact_n___268,435,456,_r___1_2.dat' using 1:7 title "Adaptive chained scan" ls 6 lw 1 pointsize 0.7 with linespoints, \
  './results/Compact_n___268,435,456,_r___1_2.dat' using 1:8 title "oneTBB" ls 1 lw 1 pointsize 0.6 with linespoints, \
  './results/Compact_n___268,435,456,_r___1_2.dat' using 1:9 title "ParlayLib" ls 8 lw 1 pointsize 0.6 with linespoints
