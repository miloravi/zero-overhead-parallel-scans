...
fn phase1_finish(workers: &Workers, data: &Phase1) {
  ...
  workers.push_task(Task::new_dataparallel(phase3_run, phase3_finish, Phase3{ output: data.output, block_size: data.block_size, sequential_block_count }, parallel_block_count as u32, false))
